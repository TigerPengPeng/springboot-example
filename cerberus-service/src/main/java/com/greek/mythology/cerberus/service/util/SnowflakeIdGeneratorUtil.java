...
public class SnowflakeIdGeneratorUtil {
    ...
    private final static LoadingCache<Long, SnowflakeIdGeneratorUtil> idGenerators = CacheBuilder
            .newBuilder().expireAfterAccess(3600, TimeUnit.SECONDS)
            .removalListener((RemovalListener<Long, SnowflakeIdGeneratorUtil>) entry -> entry.getValue().destroy()).build(new CacheLoader<Long, SnowflakeIdGeneratorUtil>() {
                @Override
                public SnowflakeIdGeneratorUtil load(Long nodeId) throws Exception {
                    SnowflakeIdGeneratorUtil idGen = new SnowflakeIdGeneratorUtil(
                            nodeId);
                    idGen.init();
                    return idGen;
                }
    ...
    /**
     * Gets an {@link SnowflakeIdGeneratorUtil} instance.
     *
     * @return
     */
    ...
    /**
     * Gets an {@link SnowflakeIdGeneratorUtil} instance for a node.
     *
     * @param nodeId
     * @return
     */
    public static SnowflakeIdGeneratorUtil getInstance(long nodeId) {
        try {
    ...
    /**
     * Constructs a new {@link SnowflakeIdGeneratorUtil} instance with specified
     * node id.
     *
     * @param nodeId
     */
    protected SnowflakeIdGeneratorUtil(long nodeId) {
        this.nodeId = nodeId;
    }
